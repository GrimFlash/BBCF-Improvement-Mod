...
DWORD GetWhiffBlockCancelJmpBackAddr = 0;
void __declspec(naked)GetWhiffBlockCancel()
{
	static CharData* addr = nullptr;

	LOG_ASM(7, "GetWhiffBlockCancel\n");
	...
	if (addr == g_interfaces.player1.GetData())
	{
		g_interfaces.player1.whiffBlockCancel = true;
	}
	else if(addr == g_interfaces.player2.GetData())
	{
		g_interfaces.player2.whiffBlockCancel = true;
	}
	
	_asm
	{
		popad
		or dword ptr[ecx + 2264h], 10000h
		jmp[GetWhiffBlockCancelJmpBackAddr]
	}
}
...
bool placeHooks_bbcf()
{
	...
	GetWhiffBlockCancelJmpBackAddr = HookManager::SetHook("GetWhiffBlockCancel", "",
		"xxxxxx????xx??xxxxxx????xx??xxxxxxxxxxxxxxxxx?x?xxxxxx????xx??xxxxxx????xx??xxxxxxxxxxxxxxxxx?x?xxxxxx????xx??xxxxxx????xx??xxxxxxxxxxxxxxxxx?x?xxxxxx????xx??xxxxxx????xx??xxxxxxxxxxxxxxxxx?x?xxxxxx????xx??xxxxxx????xx??xxxxxxxxxxxxxxxxx?x?xxxxxx????xx??xxxxxx????xx??xxxxxxxxxxxxxxxxx?x?xxxxxx????xx??xxxxxx????xx??xxxxxxxxxxxxxxxxx?x?xxxxxx", 10, GetWhiffBlockCancel);
